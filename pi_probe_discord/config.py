...
def load_config(base_dir: Path | None = None, require_webhook: bool = True) -> AppConfig:
    ...
    return AppConfig(
        ...
        dashboard_refresh_seconds=max(15, int(os.environ.get("PI_PROBE_DASHBOARD_REFRESH_SECONDS", "60"))),
        ...
        nmap_state_json=os.environ.get("PI_PROBE_NMAP_STATE_JSON", str(DEFAULT_NMAP_STATE_JSON)),
